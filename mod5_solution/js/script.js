...
(function (global) {
    ...
    function buildMenuItemsViewHtml(categoryMenuItems, menuItemsTitleHtml, menuItemHtml) {
        var catShortName = '';
        if(categoryMenuItems.category != null){
            if(categoryMenuItems.category.name != null){
                menuItemsTitleHtml = insertProperty(menuItemsTitleHtml, "name", categoryMenuItems.category.name);
            }
            if(categoryMenuItems.category.special_instructions != null){
                menuItemsTitleHtml = insertProperty(menuItemsTitleHtml, "special_instructions", categoryMenuItems.category.special_instructions);
            }
            var catShortName = (categoryMenuItems.category.short_name != null) ? categoryMenuItems.category.short_name : '';
        }
